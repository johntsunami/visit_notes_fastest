from p1py import assessment_list
...
def parse_assessments(list_of_dicts):
    add_to_write_list = ['visit_date','visit_type', 'date_of_qa', 'primary_dx','primary_disease','staff_assigned', 'discipline', 'temp','pulse','resp','bp','weight','mac','o2_sat','ambulation','toileting','trasfer','dressing','feeding','bathing']
    parse_findings = []
    write_list = []
    problem_list = []
    text_list = []
...
parse_assessments(assessment_list)
